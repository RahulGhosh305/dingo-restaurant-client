...
const TrendingCard = (props) => {
    ...
    return (
        <div class="card border-bottom border-0 mb-3">
            <div className="row g-0">
                <div class="col-md-3">
                    <div className="d-flex align-items-center d-none d-md-block">
                        <span className="text-muted fw-bold">#{count}</span>
                        <img style={{ width: 88, height: 88, borderRadius: 15, }} src={img} class=" p-2 img-fluid rounded-start" alt="..." />
                    </div>
                </div>
                <div class="col-md-5">
                    <div class="card-body">
                        <h5 class="card-title">{title}</h5>
                        <h6 class="card-text">{taka} Taka</h6>
                    </div>
                </div>
