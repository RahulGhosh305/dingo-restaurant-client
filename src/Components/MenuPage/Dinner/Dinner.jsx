...
const Dinner = () => {
    const [dinnerFood] = useFetch('https://dingo-restaurant.up.railway.app/DinnerFood')
    const [dinnerDrink] = useFetch('https://dingo-restaurant.up.railway.app/DinnerDrink')
    return (
        <>
